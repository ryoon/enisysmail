...
ActiveRecord::Schema.define(:version => 20140224001351) do
  ...
  create_table "gw_webmail_public_address_book_editable_groups", :force => true do |t|
  ...
  create_table "gw_webmail_public_address_book_editable_users", :force => true do |t|
    t.integer  "public_address_book_id"
    t.integer  "user_id"
    t.string   "user_code"
    t.string   "user_name"
  ...
  create_table "gw_webmail_public_address_book_readable_groups", :force => true do |t|
    t.integer  "public_address_book_id"
    t.integer  "group_id"
    t.string   "group_code"
    t.string   "group_name"
  ...
  create_table "gw_webmail_public_address_book_readable_users", :force => true do |t|
    t.integer  "public_address_book_id"
    t.integer  "user_id"
    t.string   "user_code"
    t.string   "user_name"
  ...
  create_table "gw_webmail_public_address_books", :force => true do |t|
    t.string   "name"
    t.integer  "state"
  ...
  create_table "gw_webmail_public_address_groups", :force => true do |t|
    t.integer  "public_address_book_id"
    t.integer  "parent_id"
    t.integer  "level_no"
    t.string   "name"
  ...
  create_table "gw_webmail_public_addresses", :force => true do |t|
    t.integer  "public_address_book_id"
    t.string   "name"
    t.string   "kana"
    t.integer  "sort_no"
  ...
  create_table "gw_webmail_public_affiliated_address_groups", :force => true do |t|
    t.integer  "public_address_book_id"
    t.integer  "group_id"
  ...
  create_table "sys_public_address_book_admin_groups", :force => true do |t|
  ...
  create_table "sys_public_address_book_admin_users", :force => true do |t|
    t.integer  "public_address_book_role_id"
    t.integer  "user_id"
    t.string   "user_code"
    t.string   "user_name"
  ...
  create_table "sys_public_address_book_roles", :force => true do |t|
