...
module Mail
  ...
  class ContentDispositionElement # :nodoc:
    def initialize( string )
      string = EnisysAdjustor.chop_last_semicolon(string)
      string = EnisysAdjustor.adjust_attachment(string)
      string = EnisysAdjustor.adjust_quotation(string, "filename")
      string = EnisysAdjustor.adjust_encoding(string, "filename")
      string = EnisysAdjustor.adjust_rfc2231_filename(string)
      string = EnisysAdjustor.adjust_rfc2231_filename_ja(string)
  ...
  class ContentTypeElement # :nodoc:
    def initialize( string )
      string = EnisysAdjustor.adjust_quotation(string, "name")
      string = EnisysAdjustor.adjust_encoding(string, "name")
      string = EnisysAdjustor.adjust_mime_type(string)
...
if Util::Config.load(:core)['mail_domain'] == 'demo.enisys.org'
